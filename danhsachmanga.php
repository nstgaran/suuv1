...
<body>
    ...
    //2. Chuẩn bị câu lệnh
    $sql = "SELECT * FROM truyen WHERE truyen_loai=2";
    //3. Thực thi câu lệnh
                        ...
                        <div class="card">
                            <?php if ($truyen['truyen_loai'] == 1) { ?>
                                <a href="chitiettruyen.php?truyen_id=<?= $truyen['truyen_id'] ?>">
                                    <img src="./assetsassets/uploads/tieuthuyet/<?= $truyen['truyen_hinhdaidien'] ?>" style="width: 100%; height: 300px;" />
                                </a>
